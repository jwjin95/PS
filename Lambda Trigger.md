...
![Untitled](C:\Users\LG\Desktop\크롬 다운로드\Lambda Trigger c68d2ef9d7124e68aff7d8bf891401a3\Untitled.png)

2.  트리거 지정 - **S3**의 지정된 버킷에서 `indicator/*.json` 파일 신규 생성 시 지정된 코드 실행

![Untitled 1](C:\Users\LG\Desktop\크롬 다운로드\Lambda Trigger c68d2ef9d7124e68aff7d8bf891401a3\Untitled 1.png)
